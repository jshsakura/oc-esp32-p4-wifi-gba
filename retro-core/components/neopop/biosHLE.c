...
=======================================
- Implemented most of the comms. ngp_bios calls.
...
most streamlined way of intercepting a ngp_bios call. The operation performed
is dependant on the current program counter. */

void iBIOSHLE(void)
{
	//Only works within the ngp_bios
	if ((ngp_pc & 0xFF0000) != 0xFF0000)
		return;

	ngp_pc --;	//Compensate for processing this instruction.
