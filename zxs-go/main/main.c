...
void app_main(void)
{
    ...
    app = rg_system_init(ZX_SAMPLE_RATE, &handlers, NULL);
    ...
    updates[0] = rg_surface_create(ZX_CONTENT_W, ZX_CONTENT_H, RG_PIXEL_565_LE, MEM_FAST);
    updates[1] = rg_surface_create(ZX_CONTENT_W, ZX_CONTENT_H, RG_PIXEL_565_LE, MEM_FAST);
